            ...
            {confirming ? (
              ...
              <>
                ...
                <ul className="max-h-[60vh] overflow-y-auto p-2">
                  {sections.length === 0 && (
                    <li className="rounded-xl border border-dashed border-white/10 bg-white/[0.025] px-4 py-8 text-center">
                      <p className="text-sm font-medium text-foreground">No matching commands</p>
                      <p className="mt-1 text-xs text-muted-foreground">
                        Try a folder, sender, proof, or command name for "{q}".
                      </p>
                    </li>
                  )}
                ...
                <div className="flex items-center gap-3 border-t border-white/5 px-4 py-2 text-[10px] text-muted-foreground">
                  <span className="mr-auto">
                    {q ? `${totalRows} result${totalRows === 1 ? "" : "s"}` : "Ready"}
                  </span>
                  <Hint keyLabel="Up/Down">Navigate</Hint>
                  <Hint keyLabel="Enter">Run</Hint>
  ...
  return (
    <li>
      ...
      >
        ...
        {disabled && (
          <span className="ml-auto rounded-md border border-amber-200/15 bg-amber-200/[0.06] px-1.5 py-0.5 text-[9px] uppercase tracking-wide text-amber-100/80">
            unavailable
          </span>
        )}
